...
+function(t) {
    ...
    function e(e) {
        return this.each(function() {
            var s = t(this)
              , o = s.data("bs.affix")
              , n = "object" == typeof e && e;
            o || s.data("bs.affix", o = new i(this,n)),
            "string" == typeof e && o[e]()
        })
    }
    var i = function(e, s) {
    ...
    i.prototype.getState = function(t, e, i, s) {
        ...
        if ("bottom" == this.affixed)
            return null != i ? o + this.unpin <= n.top ? !1 : "bottom" : t - s >= o + a ? !1 : "bottom";
...
+function(t) {
    ...
    function i(i) {
        return this.each(function() {
            var s = t(this)
              ...
              , n = "object" == typeof i && i;
            o || s.data("bs.scrollspy", o = new e(this,n)),
            "string" == typeof i && o[i]()
        })
    }
    e.VERSION = "3.3.5",
    ...
    e.prototype.process = function() {
        var t, e = this.$scrollElement.scrollTop() + this.options.offset, i = this.getScrollHeight(), s = this.options.offset + i - this.$scrollElement.height(), o = this.offsets, n = this.targets, a = this.activeTarget;
