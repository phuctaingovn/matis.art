...
/* ==========================================================================
  ...
  /* ==========================================================================
Play video chỉ chạy trên trang videomotion
   ========================================================================== */
  document.addEventListener("DOMContentLoaded", function () {
    // Kiểm tra chỉ chạy trên trang videomotion.html
    if (window.location.pathname.includes("videomotion.html")) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Lấy tất cả video trong portfolio
    const videos = document.querySelectorAll('.single-portfolio video');

    videos.forEach(video => {
      video.style.cursor = 'pointer';
      video.addEventListener('click', () => {
        // Lấy link video từ source
        const source = video.querySelector('source');
        const src = source ? source.src : video.currentSrc;

        // Gán src cho video popup
        popupVideo.src = src;
        popupVideo.load();
        popupVideo.play();
...
const popupBackground = popup.querySelector('.popup-background');
if (popupBackground) {
