...
!function(e, t) {
    ...
    var W = {
        ...
        passiveListeners: !0,
        containerModifierClass: "swiper-container-project-",
        slideClass: "swiper-slide-project",
        slideBlankClass: "swiper-slide-project-invisible-blank",
        slideActiveClass: "swiper-slide-project-active",
        slideDuplicateActiveClass: "swiper-slide-project-duplicate-active",
        slideVisibleClass: "swiper-slide-project-visible",
        slideDuplicateClass: "swiper-slide-project-duplicate",
        slideNextClass: "swiper-slide-project-next",
        slideDuplicateNextClass: "swiper-slide-project-duplicate-next",
        slidePrevClass: "swiper-slide-project-prev",
        slideDuplicatePrevClass: "swiper-slide-project-duplicate-prev",
      ...
      , F = {
        ...
        update: {
            ...
            updateAutoHeight: function(e) {
                ...
                var n = function(e) {
                    return s ? a.slides.filter((function(t) {
                        return parseInt(t.getAttribute("data-swiper-slide-project-index"), 10) === e
                    }
                    ))[0] : a.slides.eq(e)[0]
                };
            ...
            updateSlidesClasses: function() {
                ...
                (e = l ? t.$wrapperEl.find("." + i.slideClass + '[data-swiper-slide-project-index="' + r + '"]') : a.eq(r)).addClass(i.slideActiveClass),
                i.loop && (e.hasClass(i.slideDuplicateClass) ? s.children("." + i.slideClass + ":not(." + i.slideDuplicateClass + ')[data-swiper-slide-project-index="' + n + '"]').addClass(i.slideDuplicateActiveClass) : s.children("." + i.slideClass + "." + i.slideDuplicateClass + '[data-swiper-slide-project-index="' + n + '"]').addClass(i.slideDuplicateActiveClass));
                var o = e.nextAll("." + i.slideClass).eq(0).addClass(i.slideNextClass);
                i.loop && 0 === o.length && (o = a.eq(0)).addClass(i.slideNextClass);
                var d = e.prevAll("." + i.slideClass).eq(0).addClass(i.slidePrevClass);
                i.loop && 0 === d.length && (d = a.eq(-1)).addClass(i.slidePrevClass),
                i.loop && (o.hasClass(i.slideDuplicateClass) ? s.children("." + i.slideClass + ":not(." + i.slideDuplicateClass + ')[data-swiper-slide-project-index="' + o.attr("data-swiper-slide-project-index") + '"]').addClass(i.slideDuplicateNextClass) : s.children("." + i.slideClass + "." + i.slideDuplicateClass + '[data-swiper-slide-project-index="' + o.attr("data-swiper-slide-project-index") + '"]').addClass(i.slideDuplicateNextClass),
                d.hasClass(i.slideDuplicateClass) ? s.children("." + i.slideClass + ":not(." + i.slideDuplicateClass + ')[data-swiper-slide-project-index="' + d.attr("data-swiper-slide-project-index") + '"]').addClass(i.slideDuplicatePrevClass) : s.children("." + i.slideClass + "." + i.slideDuplicateClass + '[data-swiper-slide-project-index="' + d.attr("data-swiper-slide-project-index") + '"]').addClass(i.slideDuplicatePrevClass)),
                t.emitSlidesClasses()
            },
            updateActiveIndex: function(e) {
                ...
                p !== l) {
                    var h = parseInt(a.slides.eq(p).attr("data-swiper-slide-project-index") || p, 10);
                    M(a, {
                        snapIndex: t,
                        realIndex: h,
                        previousIndex: l,
            ...
            updateClickedSlide: function(e) {
                ...
                a.clickedSlide = s,
                a.virtual && a.params.virtual.enabled ? a.clickedIndex = parseInt(m(s).attr("data-swiper-slide-project-index"), 10) : a.clickedIndex = t,
        ...
        slide: {
            ...
            slideToClickedSlide: function() {
                ...
                if (a.loop) {
                    if (t.animating)
                        return;
                    e = parseInt(m(t.clickedSlide).attr("data-swiper-slide-project-index"), 10),
                    a.centeredSlides ? r < t.loopedSlides - s / 2 || r > t.slides.length - t.loopedSlides + s / 2 ? (t.loopFix(),
                    r = i.children("." + a.slideClass + '[data-swiper-slide-project-index="' + e + '"]:not(.' + a.slideDuplicateClass + ")").eq(0).index(),
                    E((function() {
                        t.slideTo(r)
                    }
        ...
        loop: {
            loopCreate: function() {
                ...
                s.each((function(t, a) {
                    ...
                    i.attr("data-swiper-slide-project-index", a)
                }
                ));
            ...
            loopDestroy: function() {
                ...
                i.removeAttr("data-swiper-slide-project-index")
            }
        },
        grabCursor: {
      ...
      , q = function() {
        ...
        n.emitContainerClasses = function() {
            ...
            if (e.params._emitClasses && e.el) {
                var t = e.el.className.split(" ").filter((function(t) {
                    return 0 === t.indexOf("swiper-container-project") || 0 === t.indexOf(e.params.containerModifierClass)
                }
                ));
        ...
        n.getSlideClasses = function(e) {
            ...
            return e.className.split(" ").filter((function(e) {
                return 0 === e.indexOf("swiper-slide-project") || 0 === e.indexOf(t.params.slideClass)
            }
            )).join(" ")
        }
        ,
        ...
        n.destroy = function(e, t) {
            ...
            r.removeAttr("style"),
            n.removeAttr("style"),
            l && l.length && l.removeClass([s.slideVisibleClass, s.slideActiveClass, s.slideNextClass, s.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-slide-project-index")),
            i.emit("destroy"),
    ...
    var j = {
        update: function(e) {
            ...
            if (e)
                ...
                for (var z = p; z <= u; z += 1)
                    (z < y || z > E) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-project-index="' + z + '"]').remove();
            ...
            t.$wrapperEl.children(".swiper-slide-project").css(m, x + "px"),
            T()
        },
        renderSlide: function(e, t) {
            ...
            var s = i.renderSlide ? m(i.renderSlide.call(a, e, t)) : m('<div class="' + a.params.slideClass + '" data-swiper-slide-project-index="' + t + '">' + e + "</div>");
            return s.attr("data-swiper-slide-project-index") || s.attr("data-swiper-slide-project-index", t),
        ...
        prependSlide: function(e) {
            ...
            if (t.params.virtual.cache) {
                ...
                Object.keys(n).forEach((function(e) {
                    var t = n[e]
                      , a = t.attr("data-swiper-slide-project-index");
                    a && t.attr("data-swiper-slide-project-index", parseInt(a, 10) + 1),
                    l[parseInt(e, 10) + s] = t
                }
                )),
                t.virtual.cache = l
    ...
    var J = {
      ...
      , se = {
        loadInSlide: function(e, t) {
            ...
            if (void 0 !== e && 0 !== a.slides.length) {
                var s = a.virtual && a.params.virtual.enabled ? a.$wrapperEl.children("." + a.params.slideClass + '[data-swiper-slide-project-index="' + e + '"]') : a.slides.eq(e)
                ...
                0 !== r.length && r.each((function(e) {
                    ...
                    a.loadImage(r[0], l || n, o, d, !1, (function() {
                        if (null != a && a && (!a || a.params) && !a.destroyed) {
                            ...
                            a.params.loop && t) {
                                var e = s.attr("data-swiper-slide-project-index");
                                if (s.hasClass(a.params.slideDuplicateClass)) {
                                    var u = a.$wrapperEl.children('[data-swiper-slide-project-index="' + e + '"]:not(.' + a.params.slideDuplicateClass + ")");
                                    a.lazy.loadInSlide(u.index(), !1)
                                } else {
                                    var c = a.$wrapperEl.children("." + a.params.slideDuplicateClass + '[data-swiper-slide-project-index="' + e + '"]');
        ...
        load: function() {
            ...
            function o(e) {
                if (r) {
                    if (t.children("." + a.slideClass + '[data-swiper-slide-project-index="' + e + '"]').length)
                        return !0
                } else if (i[e])
                    return !0;
                return !1
            ...
            function d(e) {
                return r ? m(e).attr("data-swiper-slide-project-index") : m(e).index()
            }
            if ("auto" === l && (l = 0),
            e.lazy.initialImageLoaded || (e.lazy.initialImageLoaded = !0),
            e.params.watchSlidesVisibility)
                t.children("." + a.slideVisibleClass).each((function(t) {
                    var a = r ? m(t).attr("data-swiper-slide-project-index") : m(t).index();
      ...
      , ne = {
        ...
        init: function() {
            ...
            var i = e.$wrapperEl
              , s = i.attr("id") || "swiper-wrapper-project-" + e.a11y.getRandomNumber(16)
            ...
            e.slides.each((function(a, i) {
                var s = m(a)
                  , r = e.params.loop ? parseInt(s.attr("data-swiper-slide-project-index"), 10) : i
      ...
      , ue = {
        setTranslate: function() {
            ...
            for (var v = 0; v < s.length; v += 1) {
                var f = s.eq(v)
                  , g = v;
                c && (g = parseInt(f.attr("data-swiper-slide-project-index"), 10));
                var b = 90 * g
                  , w = Math.floor(b / 360);
                l && (b = -b,
                w = Math.floor(-b / 360));
                ...
                f.transform(C),
                p.slideShadows) {
                    var S = u ? f.find(".swiper-slide-project-shadow-left") : f.find(".swiper-slide-project-shadow-top")
                      , M = u ? f.find(".swiper-slide-project-shadow-right") : f.find(".swiper-slide-project-shadow-bottom");
                    0 === S.length && (S = m('<div class="swiper-slide-project-shadow-' + (u ? "left" : "top") + '"></div>'),
                    f.append(S)),
                    0 === M.length && (M = m('<div class="swiper-slide-project-shadow-' + (u ? "right" : "bottom") + '"></div>'),
                    f.append(M)),
        ...
        setTransition: function(e) {
            var t = this
              , a = t.$el;
            t.slides.transition(e).find(".swiper-slide-project-shadow-top, .swiper-slide-project-shadow-right, .swiper-slide-project-shadow-bottom, .swiper-slide-project-shadow-left").transition(e),
      ...
      , ce = {
        setTranslate: function() {
            for (var e = this, t = e.slides, a = e.rtlTranslate, i = 0; i < t.length; i += 1) {
                ...
                e.params.flipEffect.slideShadows) {
                    var p = e.isHorizontal() ? s.find(".swiper-slide-project-shadow-left") : s.find(".swiper-slide-project-shadow-top")
                      , u = e.isHorizontal() ? s.find(".swiper-slide-project-shadow-right") : s.find(".swiper-slide-project-shadow-bottom");
                    0 === p.length && (p = m('<div class="swiper-slide-project-shadow-' + (e.isHorizontal() ? "left" : "top") + '"></div>'),
                    s.append(p)),
                    0 === u.length && (u = m('<div class="swiper-slide-project-shadow-' + (e.isHorizontal() ? "right" : "bottom") + '"></div>'),
                    s.append(u)),
        ...
        setTransition: function(e) {
            var t = this
              ...
              , i = t.activeIndex
              , s = t.$wrapperEl;
            if (a.transition(e).find(".swiper-slide-project-shadow-top, .swiper-slide-project-shadow-right, .swiper-slide-project-shadow-bottom, .swiper-slide-project-shadow-left").transition(e),
            t.params.virtualTranslate && 0 !== e) {
                var r = !1;
      ...
      , he = {
        setTranslate: function() {
            for (var e = this, t = e.width, a = e.height, i = e.slides, s = e.slidesSizesGrid, r = e.params.coverflowEffect, n = e.isHorizontal(), l = e.translate, o = n ? t / 2 - l : a / 2 - l, d = n ? r.rotate : -r.rotate, p = r.depth, u = 0, c = i.length; u < c; u += 1) {
                ...
                r.slideShadows) {
                    var S = n ? h.find(".swiper-slide-project-shadow-left") : h.find(".swiper-slide-project-shadow-top")
                      , M = n ? h.find(".swiper-slide-project-shadow-right") : h.find(".swiper-slide-project-shadow-bottom");
                    0 === S.length && (S = m('<div class="swiper-slide-project-shadow-' + (n ? "left" : "top") + '"></div>'),
                    h.append(S)),
                    0 === M.length && (M = m('<div class="swiper-slide-project-shadow-' + (n ? "right" : "bottom") + '"></div>'),
                    h.append(M)),
        ...
        setTransition: function(e) {
            this.slides.transition(e).find(".swiper-slide-project-shadow-top, .swiper-slide-project-shadow-right, .swiper-slide-project-shadow-bottom, .swiper-slide-project-shadow-left").transition(e)
        }
    }
      , ve = {
        init: function() {
        ...
        onThumbClick: function() {
            ...
            if (t) {
                ...
                if (!(i && m(i).hasClass(e.params.thumbs.slideThumbActiveClass) || null == a)) {
                    var s;
                    if (s = t.params.loop ? parseInt(m(t.clickedSlide).attr("data-swiper-slide-project-index"), 10) : a,
                    e.params.loop) {
                        var r = e.activeIndex;
                        e.slides.eq(r).hasClass(e.params.slideDuplicateClass) && (e.loopFix(),
                        e._clientLeft = e.$wrapperEl[0].clientLeft,
                        r = e.activeIndex);
                        var n = e.slides.eq(r).prevAll('[data-swiper-slide-project-index="' + s + '"]').eq(0).index()
                          , l = e.slides.eq(r).nextAll('[data-swiper-slide-project-index="' + s + '"]').eq(0).index();
            ...
            if (a) {
                ...
                if (t.realIndex !== a.realIndex || r) {
                    ...
                    if (a.params.loop) {
                        ...
                        o = a.activeIndex);
                        var d = a.slides.eq(o).prevAll('[data-swiper-slide-project-index="' + t.realIndex + '"]').eq(0).index()
                          , p = a.slides.eq(o).nextAll('[data-swiper-slide-project-index="' + t.realIndex + '"]').eq(0).index();
                ...
                a.params.loop || a.params.virtual && a.params.virtual.enabled)
                    for (var h = 0; h < u; h += 1)
                        a.$wrapperEl.children('[data-swiper-slide-project-index="' + (t.realIndex + h) + '"]').addClass(c);
                else
                    for (var v = 0; v < u; v += 1)
      ...
      , fe = [U, Z, {
        ...
        params: {
            zoom: {
                ...
                zoomedSlideClass: "swiper-slide-project-zoomed"
            }
        },
        create: function() {
            var e = this;
        ...
        params: {
            thumbs: {
                ...
                autoScrollOffset: 0,
                slideThumbActiveClass: "swiper-slide-project-thumb-active",
                thumbsContainerClass: "swiper-container-project-thumbs"
            }
        },
        create: function() {
            z(this, {
